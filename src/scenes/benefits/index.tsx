...
/**
 * staggerChildren: 0.2 : all the div inside container will be staggered.
 */
const container = {
  hidden: {},
  visible: {
  ...
  return (
    <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
      ...
      >
        ...
        {/**
         * md:flex : big screen, components are flex.
         */}
        {/** BENEFITS */}
        <motion.div
        ...
        <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
          ...
          <div>
            ...
            <div className="relative">
              {/**
               * making the image behind, top, left of the HText title.
               */}
              <motion.div
            ...
            <div className="relative mt-16">
              {/**
               * before:z-[-1] : positioning element behind everything.
               */}
